...
# primers_df = primers.describe_primers("/storage/BINF/PawelLab/mkowalski/mkowalski/primers/data/mcb_design/primers")
# primers_df.to_csv("/storage/BINF/PawelLab/mkowalski/mkowalski/primers/data/mcb_design/data/primers.csv", index = False)
