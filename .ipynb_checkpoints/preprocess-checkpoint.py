...
# sequence_df = data.describe_sequences(seqs_path = "/storage/BINF/PawelLab/mkowalski/mkowalski/primers/data/PROPER_PYPRIMER/ungapped_filtered_msa.fasta", verbose = True)
# sequence_df.to_csv("/storage/BINF/PawelLab/mkowalski/mkowalski/primers/data/PROPER_PYPRIMER/test_sequence_df.csv", index = False)
