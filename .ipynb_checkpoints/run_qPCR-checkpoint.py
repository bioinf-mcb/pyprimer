...
if __name__ == "__main__":
    resdir = "/storage/BINF/PawelLab/mkowalski/mkowalski/primers/data/mcb_design/results/50mv_12dv"
    tmpdir = "/storage/BINF/PawelLab/mkowalski/mkowalski/primers/data/mcb_design/tmp"
